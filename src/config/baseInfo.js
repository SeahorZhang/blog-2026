...
export const socialLinks = [
  {
    label: 'GitHub',
    url: 'https://github.com/SeahorZhang',
...
export const projects = [
  {
    ...
    summary: '浏览器首页导航',
    description:
      '一款高度可定制的浏览器新标签页扩展，支持自定义布局、网站收藏和搜索引擎，为您提供更高效的网络导航体验。',
